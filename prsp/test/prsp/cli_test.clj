    ...
    (utils/with-temp-dir [base-dir {}]
      ...
      (is (= (sort (vec (map str (file-seq (fs/file base-dir)))))
             (sort [(str base-dir "")
                    ...
                    (str base-dir "/store")
                    (str base-dir "/store/keys")
                    (str base-dir "/store/keys/id_prsp")
                    (str base-dir "/store/keys/id_prsp.pub")
                    (str base-dir "/store/fetches")
                    (str base-dir "/store/fetches/0")
                    (str base-dir "/store/fetches/0/fetch-info.edn")
                    (str base-dir "/store/.gitignore")
                    (str base-dir "/store/fetches.HEAD")
                    (str base-dir "/store/fetches.HEAD/fetch-info.edn")])))
